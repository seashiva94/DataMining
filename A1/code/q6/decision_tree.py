...
def test_performance(data, method):
    ...
    best_root = None
    for i in range(5):
        print "Training decision tree", i+1
        ...
        if accuracy > best_acc:
            ...
            best_root = root
        total += accuracy
        print "accuracy on run",i+1,":",accuracy
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print "filename: [data/iris_data.csv, data/breastcancer_data.csv, data/wine_data.csv]"
        exit()
    method = sys.argv[1]
    filename = sys.argv[2]
    ...
    print "average accuracy after 5 runs :", avg_accuracy
